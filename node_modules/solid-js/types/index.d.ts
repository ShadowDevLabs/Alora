export { $DEVCOMP, $PROXY, $TRACK, batch, catchError, children, createComputed, createContext, createDeferred, createEffect, createMemo, createReaction, createRenderEffect, createResource, createRoot, createSelector, createSignal, enableExternalSource, enableScheduling, equalFn, getListener, getOwner, on, onCleanup, onError, onMount, runWithOwner, startTransition, untrack, useContext, useTransition } from "solid-js/types/reactive/signal.js";
...
export declare const DEV: {
    readonly hooks: {
        ...
        afterCreateSignal: ((signal: import("solid-js/types/reactive/signal.js").SignalState<any>) => void) | null;
        afterRegisterGraph: ((sourceMapValue: import("solid-js/types/reactive/signal.js").SourceMapValue) => void) | null;
    };
